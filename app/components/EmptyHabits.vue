...
<template>
  <div class="relative mx-3 mb-3 flex flex-col items-center justify-center overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-950 text-center">
